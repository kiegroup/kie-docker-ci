...
public class ContainerActionsCell extends AbstractSafeHtmlCell<String> {
    ...
    public interface DoContainerActionCallback
    {
        ...
        void onDownloadArtifact(final KieContainer container);
    }
    ...
    public static final SafeHtml ICON_DOWNLOAD = makeImage(Images.INSTANCE.downloadIcon());
        ...
        if ("click".equals(event.getType())) {
            ...
            if (parent.isOrHasChild(Element.as(eventTarget))) {
                ...
                if (callback != null && el.getNodeName().equalsIgnoreCase("IMG")) {
                    ...
                    } else if (ContainerActionsCell.DOWNLOAD.equals(s) && isKieApp) {
                        callback.onDownloadArtifact(container);
                    }
                }
    ...
    protected void render(com.google.gwt.cell.client.Cell.Context context,
        ...
        */
        ...
        if (isKieApp) {
            ...
            rendered = templates.cell(DOWNLOAD, enabledStyle, ICON_DOWNLOAD, Constants.INSTANCE.downloadWAR());
            sb.append(rendered);
        }
