...
public class TimeoutPopupPanel extends PopupPanel {
    ...
    private Timer timer;
    private int duration = 30000; // Default timeout at 1min.
    ...
    private Alert buildDefaultTimeoutPanel() {
        ...
        final String m = Constants.INSTANCE.timeoutFired();
    ...
    public static class TimeoutFiredEvent extends GwtEvent<TimeoutFiredEventHandler> {
        ...
        public static Type<TimeoutFiredEventHandler> TYPE = new Type<TimeoutFiredEventHandler>();
